...
open (IN, 'navs_aachanges_+_pathogenicity.txt');

@gns = ("SCN10A","SCN11A","SCN1A","SCN2A","SCN3A","SCN4A","SCN5A","SCN8A","SCN9A");
...
#P35498	SCN1A	Nav1.1	non-polar	1236	non-polar	1214-1237	S1DIII	Pathogenic
